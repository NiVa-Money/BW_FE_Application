...
//             <button className="bg-[#A5FFD6] text-black px-6 py-3 rounded-lg font-semibold flex items-center gap-2 transition-transform hover:scale-105 shadow-lg shadow-green-500/50">
//               <span>✨</span>
