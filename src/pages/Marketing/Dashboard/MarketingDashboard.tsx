...
//               <p className="text-sm text-gray-600">
//                 Utilize AI for content creation, analyzing campaign performance,
//                 and generating customer insights
//               </p>
//             </div>
//           </div>
...
//             </div>
//             <button className="text-indigo-600 text-sm">View dashboard</button>
//           </div>
//           <div>
//             <div className="flex items-center space-x-2 mb-2">
