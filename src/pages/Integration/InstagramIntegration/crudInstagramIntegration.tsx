...
//   // Fetch the user's bots on mount
//   useEffect(() => {
//     if (userIdLocal?.length) {
//       dispatch(getBotsAction(userIdLocal));
//     }
...
//   // Format and store the bots in local state
//   useEffect(() => {
//     if (
//       Array.isArray(botsDataRedux) &&
//       botsDataRedux.length &&
...
//   // Fetch the specific Instagram integration using integrationId
//   useEffect(() => {
//     const fetchIntegration = async () => {
//       try {
//         if (!integrationId) {
//           console.error("No integrationId provided in URL");
//           return;
//         }
...
//             (item: any) => item._id === integrationId
//           );
//           if (found) {
//             setFormData({
//               botId: found.botId || "",
...
//         !formData.commentEngagementEnable ||
//         !formData.dmEngagementEnable
//       ) {
...
//   // Handle "Delete" => Deactivate integration
//   const handleDelete = async () => {
//     try {
//       if (!integrationId) {
//         console.log("No integration ID found to deactivate.");
      ...
      <div className="max-w-6xl mx-auto">
        <div className="rounded-2xl p-8">
          ...
          <p className="text-gray-600 text-lg mb-8">
            Please update the details for the Instagram Integration.
          </p>
