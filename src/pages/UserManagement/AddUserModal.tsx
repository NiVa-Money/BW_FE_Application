...
//                   />
//                   <span className="ml-2 text-sm text-gray-700">Integrations</span>
//                 </label>
...
//                     onChange={() => handleRoleChange(userData.role === 'manager' ? null : 'manager')}
//                   />
...
//                     onChange={() => handleRoleChange(userData.role === 'co-owner' ? null : 'co-owner')}
//                   />
...
//                     onChange={() => handleRoleChange(userData.role === 'agent' ? null : 'agent')}
//                   />
